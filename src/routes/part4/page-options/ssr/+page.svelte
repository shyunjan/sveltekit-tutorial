...
<div class="tutorial">
  <p>
    ...
    index content that is rendered in the browser with JavaScript, it happens less frequently and
    reliably.
  </p>
  <p>That said, some components can't be rendered on the server, perhaps because they expect to be
